...
async function getTenantShowRegionForUser(userId) {
  try {
    ...
    if (!tData || tData.length === 0) {
      console.log('[AccessControl] show_regions: no tenant found for tenant_id:', tuData[0].tenant_id);
      return false;
    }
